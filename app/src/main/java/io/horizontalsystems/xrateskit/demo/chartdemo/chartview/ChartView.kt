...
class ChartView : View {
    ...
    fun setData(points: List<ChartPointFloat>, chartType: ChartType, startTimestamp: Long, endTimestamp: Long, currency: Currency? = null) {
    ...
    private fun setColour(points: List<ChartPointFloat>, endTimestamp: Long) {
    ...
    private fun setPoints(points: List<ChartPointFloat>, chartType: ChartType, startTimestamp: Long, endTimestamp: Long, currency: Currency?) {
        helper.scale(points)
