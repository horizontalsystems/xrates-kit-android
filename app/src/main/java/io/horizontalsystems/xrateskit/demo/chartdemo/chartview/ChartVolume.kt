...
class ChartVolume(private val config: ChartConfig) {
    ...
    fun init(points: List<ChartPointFloat>, startTimestamp: Long, endTimestamp: Long, shape: RectF) {
    ...
    private fun getBars(points: List<ChartPointFloat>, startTimestamp: Long, endTimestamp: Long): List<VolumeBar> {
        ...
        chunks.forEachIndexed { index, chunk ->
            ...
            val xLeft = (chunk.start - startTimestamp) * deltaX + leftMargin
    ...
    private fun getChunks(points: List<ChartPointFloat>): MutableList<VolumeChunk> {
